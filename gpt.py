...
from db import get_news_from_db, add_news_details_to_db, is_title_in_details_db
import json
import os
...
def main():
    ...
    for news in tqdm(news_from_db):
        ...
        add_news_details_to_db(news['title'], response_dict)
